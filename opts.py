...
def parse_opts():
    ...
    parser.add_argument('--gpu_id', type=str, nargs='+', default=[0,1,2,3])
    ...
    parser.add_argument('--loss_caption_cl', default=0, type=float)
    ...
    # new
    parser.add_argument('--gpt_beam_size', type=int, default=3)
    parser.add_argument('--gpt_layer', type=int, default=2)
    parser.add_argument('--add_cross_attention', type=bool, default=False)
    parser.add_argument('--bank_folder', type=str, default='clip')
    parser.add_argument('--multiscale_project_step', type=int, default=2)
    parser.add_argument('--var_scale', type=float, default=1.0)
    parser.add_argument('--capQ_addP', type=str, default='after')
    parser.add_argument('--contrastive_loss_coef', type=float, default=0.50)

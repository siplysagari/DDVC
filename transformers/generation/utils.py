    ...
    def _expand_inputs_for_generation(
        ...
        **model_kwargs,
        ...
        if prefix is not None:
            # print(expanded_return_idx,prefix.shape)
            prefix = prefix.repeat_interleave(expand_size, dim=0)
    ...
    def _greedy_search(
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            ...
            if model_inputs["input_ids"][0][0] in [40290,50257,50256,21231,0]:
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            ...
            if sequential:
                ...
                if ("input_ids" in model_inputs) and (model_inputs["input_ids"][0][0] in [40290,21231 ,50256, 50257,0]):
            # if model_inputs["input_ids"][0][0] == 40290:
                    outputs = self(
                        **model_inputs,
                        return_dict=True,
